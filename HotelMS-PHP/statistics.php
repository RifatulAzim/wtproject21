 ...
 <script type="text/javascript">
  ...
  <script type="text/javascript">
   ...
   function drawChart() {
       ...
       dataTable.addRows([
          [ new Date(2021, 3, 13), 6   ],
          [ new Date(2021, 3, 14), 7   ],
          [ new Date(2021, 3, 15), 2   ],
          [ new Date(2021, 3, 16), 3   ],
          [ new Date(2021, 3, 17), 3   ],
           //
          [ new Date(2021, 4, 13), 5   ],
          ...
          [ new Date(2020, 9, 4), 3 ],
          [ new Date(2020, 9, 5), 5],
          [ new Date(2019, 9, 12), 6],
          [ new Date(2019, 9, 13), 7],
          [ new Date(2019, 9, 19), 1 ],
          [ new Date(2019, 9, 23), 3],
          [ new Date(2019, 9, 24), 5],
          [ new Date(2019, 9, 30), 2 ]
        ]);
